...
class _ComponentsPageState extends State<ComponentsPage>
  ...
  Future<void> popularModelosNoFirestore() async {
    ...
    final aiModelsToRegister = [
      ...
      const AiModelModel(
        id: '',
        name: 'Whisper GGLM Tiny',
        description: 'Modelos ultracompacto gglm para Whisper',
        fileName: 'whisper.cpp-ggml-tiny.gguf',
        downloadUrl:
            'https://firebasestorage.googleapis.com/v0/b/summary-ia-app.firebasestorage.app/o/models%2Fwhisper.cpp-ggml-tiny.gguf?alt=media&token=b34c63fe-868d-433c-93de-01d59c929ac1',
        sizeInBytes: 77691713,
        parameterCount: '-',
